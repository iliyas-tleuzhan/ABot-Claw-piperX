...
| PiPER-X     | `http://127.0.0.1:8892` | `robot_layer/arm_piper_x/README.md` | `robot_layer/arm_piper_x/agent_server/config/piper_x_robot_contract.yaml` |
...
- Current stack: ROS 2 Jazzy `agx_arm_ros`, MoveIt, RealSense D435i, ArUco ID 6, and local HTTP bridge on `127.0.0.1:8892`
...
- Control/API endpoint for PiPER-X marker/home: `http://127.0.0.1:8892`
